...
<ul id="acts" class="grid_3 alpha">
    ...
    <li><a href="http://twitter.com/home?status=IN/OUT%20for%20<?=rawurlencode(Router::url('',true));?>" title="Click to share this post on Twitter">Twitter</a></li>
    <li><a href="http://www.facebook.com/sharer.php?t=<?=urlencode($post['Post']['title']);?>&u=<?=rawurlencode(Router::url('',true));?>" title="Click to share this post on Facebook">Facebook</a></li>
    </ul>
